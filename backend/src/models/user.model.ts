...
// Type for User Model
export type UserDocument = HydratedDocument<IUser, IUserMethods>; // Document with methods
export type UserModelType = Model<IUser, Record<string, never>, IUserMethods>; // Model type
export type UserObject = IUser; // Plain object type
